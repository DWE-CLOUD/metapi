    ...
    <div className="flex min-h-screen flex-col">
      <div className="flex flex-1 flex-col justify-center px-6 py-12 relative">
        ...
        <div className="mx-auto w-full max-w-sm animate-fade-in">
          ...
          <h2 className="text-center text-2xl font-bold leading-9 tracking-tight mb-2">Welcome back</h2>
          <p className="text-center text-sm text-muted-foreground mb-8">Sign in to your account to continue</p>
        </div>
